...
1. Download `RekonOnlineFoodSetup-1.04.exe`.
...
- App standalone: `dist\RekonOnlineFood-1.04\RekonOnlineFood-1.04.exe`
...
1. Jalankan `dist\installer\RekonOnlineFoodSetup-1.04.exe`.
