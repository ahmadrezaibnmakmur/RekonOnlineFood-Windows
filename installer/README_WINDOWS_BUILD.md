...
1. Download `RekonOnlineFoodSetup-1.05.exe`.
...
- App standalone: `dist\RekonOnlineFood-1.05\RekonOnlineFood-1.05.exe`
- Installer: `dist\installer\RekonOnlineFoodSetup-1.05.exe`

Jika Inno Setup belum terinstall, build akan berhenti supaya tidak ada installer lama yang tidak sengaja diupload.

## Test user journey

1. Jalankan `dist\installer\RekonOnlineFoodSetup-1.05.exe`.
